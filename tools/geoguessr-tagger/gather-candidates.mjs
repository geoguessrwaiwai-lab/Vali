...
// Usage:
//   node gather-candidates.mjs <outFile.json> [--per-file=N] [--countries=UA,KR,...] [--radius=N]
//
...
if (!outFile) {
  console.error('Usage: node gather-candidates.mjs <outFile.json> [--per-file=N] [--countries=UA,KR,LS,SZ,BT,BO,UY] [--radius=N]');
  process.exit(1);
}
